    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.properties.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_map_location') ? 'is-invalid' : '' }}" type="text" name="google_map_location" id="google_map_location" value="{{ old('google_map_location', '') }}" required>
